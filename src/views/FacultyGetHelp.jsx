...
const internStateData = [
	...
	{
		name: "Out of State Interns",
		students: outStateInterns,
		fill: "darkorange",
	},
];
			...
			<div className="min-h-full">
				...
				<header className="bg-gray-800 shadow">
					...
					<div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
						<h1 className="text-3xl font-bold text-nwgreen">Faculty </h1>
					</div>
				</header>
				<main>
					{" "}
					...
					<div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
						<div className="px-4 py-6 sm:px-0">
							...
							<div className="border-8 border-double border-nwgreen rounded-md h-full">
								{" "}
								{/* Everything inside the double border */}
								<div> Placeholder Help Info</div>
							</div>
						</div>
						{/* /End replace */}
					</div>
