...
const navigation = [
	{
		name: "Applications",
		href: "/facultyStaffStudentOverview",
		current: false,
	},
				...
				<header className="bg-gray-800 shadow">
					...
					<div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
						<h1 className="text-3xl font-bold text-nwgreen">
							Faculty/Admin Application View{" "}
						</h1>
					</div>
				</header>
				<main>
					...
					<div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
						<div className="px-4 py-6 sm:px-0">
							...
							<div className="border-8 border-double border-nwgreen rounded-md h-96">
								{" "}
								{/* Everything inside the dashed border */}
								...
								<div className="">
									{" "}
									{/* Bottom Row */}
									<div className="p-1 border-t border-r border-solid basis">
										{" "}
										{/* Bottom Left Box */}
										<div>
											{" "}
											<b> Internship Information </b>{" "}
										</div>
